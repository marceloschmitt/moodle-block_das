...
$string['grades_chart'] = 'Avaliações';
$string['grades_distribution'] = "Distribuição de avaliações";
...
$string['in_time_ratio'] = 'Relação de pontualidade';
...
$string['task_list'] = "Lista de avaliações";
$string['task_name'] = "Avaliações";

$string['total_grades'] = "Quantidade de notas";
